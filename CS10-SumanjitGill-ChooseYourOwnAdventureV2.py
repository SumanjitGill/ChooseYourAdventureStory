...
Additional commands:\n\
    ...
    while financial_riddle == False and node == study:
        if 'under sofa' in user_command:
            print(sofa)
            
        if 'bookshelf'in user_command:
            print(bookshelf)
    ...
    if financial_riddle == True and node == study and sakshi_two == 0:
        print(sakshi_2)
        sakshi_two+=1
        
    while game_one == False and node == garden:
        if 'bushes' in user_command:
            print(bushes)
            
        if 'trees' in user_command:
            print(trees)
    ...
    if game_one == True and node == garden and andres_two == 0:
        print(andres_2)
        andres_two+=1
        
    while game_two == False and node == kitchen:
        if 'cupboard' in user_command:
            leng_hangman()
            
        if 'fridge' in user_command:
            print(fridge)
        
        if 'sink' in user_command:
            print(sink)
            
        if pic_2 in hang.inventory:
            game_two = True
            
    if game_two == True and node == kitchen and leng_two == 0:
        print(leng_2)
        leng_two +=1
            
    if node == living_room and bree_two == 0:
        print(bree_2)
        bree_two +=1
